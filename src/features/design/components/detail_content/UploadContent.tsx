          ...
          {isFetching ? (
            ...
            <div className="grid w-full grid-cols-2 gap-3">
              {uploadedFiles.map((file) => (
                ...
                >
                  <img
                    src={getImageUrl(file.image_path)}
                    alt="Uploaded"
                    className="w-full h-auto object-contain"
                    draggable
                    onDragStart={(event) =>
                      setDragImageData(event, getImageUrl(file.image_path))
                    }
                    onClick={() =>
                      requestImageFill(getImageUrl(file.image_path))
                    }
                  />
                </div>
              ))}
        ...
        <>
          ...
          >
            <button
              ...
              onClick={() => {
                handleDeleteUpload(contextMenu.id);
                setContextMenu(null);
              }}
            >
              삭제하기
